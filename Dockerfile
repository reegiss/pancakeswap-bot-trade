...
LABEL net.r3tecnologia.pancake-trading-bot.package-version=${PACKAGE_VERSION}

ARG GIT_HASH=unspecified
ENV GIT_HASH=${GIT_HASH}
LABEL net.r3tecnologia.pancake-trading-bot.git-hash=${GIT_HASH}

ARG NODE_ENV=development
ENV NODE_ENV=${NODE_ENV}
LABEL net.r3tecnologia.pancake-trading-bot.node-env=${NODE_ENV}
